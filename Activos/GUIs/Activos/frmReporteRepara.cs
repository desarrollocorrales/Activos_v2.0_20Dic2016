...
{
    public partial class frmReporteRepara : Form
    {
        public frmReporteRepara()
        {
            InitializeComponent();
        }
        ...
        public string _activacion = string.Empty;

        private void frmReporteRepara_Load(object sender, EventArgs e)
        {
            ...
            parameters[3] = new ReportParameter("pActivacion", this._activacion);
            //
        ...
        private void frmReporteRepara_FormClosed(object sender, FormClosedEventArgs e)
        {
